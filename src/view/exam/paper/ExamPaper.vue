...
<!--                      <Button type="error" icon="ios-trash" >禁用</Button>-->
<!--                    </Poptip>-->
        </Row>
        <br>
        <Row>
    ...
    return {
      ...
      columns1: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', [
              h('strong', params.row.deleted ? '已禁用' : '启用')
            ])
          }
        },
        {
                ...
                on: {
                  click: () => {
                    ...
                    axios.request({
                      ...
                      params.row.deleted = !params.row.deleted
              ...
              h('Button', {
                ...
                on: {
                  click: () => {
                    ...
                    if (params.row.status == 2) {
                      window.open(baseUrl + '/#/read?id=' + id + '&cl=1')
                    } else if (params.row.status == 1) {
                      window.open(baseUrl + '/#/edit?id=' + id + '&cl=1')
                    }
                  }
                }
